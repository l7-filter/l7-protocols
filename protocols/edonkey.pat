...
# Protocol groups: p2p
#
# Tested recently with eMule 0.47a and eDonkey2000 1.4 and a long time
# ago with something else. 
# 
# This matches much of what eMule does when you
# tell it to only connect to the KAD network.  I don't quite know what
# to make of this.
#
